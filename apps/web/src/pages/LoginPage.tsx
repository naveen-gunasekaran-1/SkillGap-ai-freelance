          ...
          <div className="hidden flex-col justify-center lg:flex animate-fade-in-up">
            <div className="rounded-3xl bg-gradient-to-br from-primary-light via-white to-ai-cyan/10 p-10">
              ...
              <p className="mt-4 text-text-secondary leading-relaxed">
                Sign in to access your personalized gap analysis, track applications, and discover
                ...
                <div className="flex items-center gap-3 rounded-card bg-white/80 p-4 shadow-card">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-text-secondary">
                      See every application status update instantly
                    </p>
                  </div>
                </div>
                <div className="flex items-center gap-3 rounded-card bg-white/80 p-4 shadow-card">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-text-secondary">
                      AI-curated courses based on your specific gaps
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="w-full max-w-md mx-auto lg:mx-0">
              ...
              <div className="mt-8 grid gap-3 sm:grid-cols-2">
                <button
                  ...
                  className="flex items-center justify-center gap-2.5 rounded-card border border-border bg-white px-4 py-3 text-sm font-medium text-text-primary shadow-card transition-all duration-150 hover:-translate-y-0.5 hover:shadow-card-hover"
                >
              ...
              <div className="relative my-8">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                  <span className="bg-background px-3 text-text-secondary">
